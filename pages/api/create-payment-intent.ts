...
export default async function handler(
	...
	//Get user
	const userSession = (await getServerSession(req, res, authOptions)) as any
	if (!userSession?.user) {
	...
	// Create order data (this is Prisma code using Prisma functions like connect and create)
	const orderData = {
